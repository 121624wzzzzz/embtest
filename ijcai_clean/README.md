...
本目录整理自历史路径 `/root/shared-nvme/ijcai`，保留当前 embedding / unembedding 几何分析代码、轻量结果和文档。大权重、下载缓存和标准化抽取矩阵仍在仓库根目录。
...
| `src/ijcai_clean/` | 分析代码包：加载 E/U、token 对齐、GCorr、Task1-6 实现 |
