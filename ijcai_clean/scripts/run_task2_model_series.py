#!/usr/bin/env python3
"""
任务二：系列组内 GCorr（基于 extracts/ 与 ijcai_clean 包）。

用法:
  export PYTHONPATH=ijcai_clean/src
  python ijcai_clean/scripts/run_task2_model_series.py --devices auto
...
from ijcai_clean.experiments.task2 import run_task2_model_series  # noqa: E402
...
def main() -> None:
    ...
    p.add_argument(
        "--series",
        type=Path,
        default=_REPO_ROOT / "ijcai_clean" / "configs" / "model_series.yaml",
        help="系列配置 YAML",
    )
    p.add_argument(
        "--extracts",
