...
用法:
  python cross_model_geometry/scripts/run_task6_base_instruct_full_vocab_affine.py
"""
...
def main() -> None:
    out_dir = _REPO_ROOT / "cross_model_geometry" / "results" / "task6_base_instruct_full_vocab"
