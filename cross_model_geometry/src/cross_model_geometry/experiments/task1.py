...
from cross_model_geometry.alignment import TokenSampler, build_pair_token_info
from cross_model_geometry.data import (
    actual_tied,
    find_model_cache_dir,
    load_E_U_matrices,
    load_info_json,
)
from cross_model_geometry.experiments.gcorr_io import (
...
from cross_model_geometry.experiments.gcorr_validation import validate_completed_pairs_compute
from cross_model_geometry.metrics import compute_single_pair_bootstrap
...
def run_task1_base_instruct(
    *,
    ...
    if torch.cuda.is_available():
        from cross_model_geometry.metrics import (
