...
本目录为 **可独立抽走** 的自包含包：分析叙事、模型配置、原始结果 CSV、特殊案例说明。  
...
| 文件 | 内容 |
|------|------|
| [`docs/SPECIAL_CASES.md`](docs/SPECIAL_CASES.md) | Gemma-4 gauge、DeepSeek-V4 架构例外 |

## 排除约定

| 分组 | 排除 | 原因 |
|------|------|------|
| untied 静态谱 | DeepSeek-V4-Flash / Pro | 裸 U 非传统 lm_head |
| tied 静态谱 / Task1 BI | Gemma-4 全系、Gemma-3-1B | gauge 异常 / BI 主分析排除 |
