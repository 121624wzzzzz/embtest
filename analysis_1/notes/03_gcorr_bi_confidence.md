...
\*tied：排除 Gemma-4 全系与 Gemma-3-1B；原因见 [`gemma4_checkpoint_gauge`](../../docs/分析口径与特殊案例.md#62-gemma4_checkpoint_gauge) / [`gemma3_1b_rewrite`](../../docs/分析口径与特殊案例.md#61-gemma3_1b_rewrite)。
